<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete">
  <head>
    ...
    <title>Alienfinity - NFT Marketplace</title>
  ...
  <body>
    ...
    <div id="root">
      <div>
        <div>
          <div class="main">
            <header id="header">
              <nav data-aos="zoom-out" data-aos-delay="800" class="navbar navbar-expand navbar-sticky" style="">
                <div class="container header">
                  <a class="navbar-brand" href="/">
                    <img class="navbar-brand-sticky" src="img/logo.png" alt="sticky brand-logo">
                  </a>
                  <div class="ml-auto"></div>
                  <ul class="navbar-nav action">
                    <li class="nav-item ml-3">
                      <a href="/login" class="btn ml-lg-auto btn-bordered-white">
                        <i class="icon-wallet mr-md-2"></i>Login </a>
                    </li>
                  </ul>
                </div>
              </nav>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-12 col-md-6 col-lg-7">
                    <span>Alienfinity</span>
                    <h1 class="mt-4">Discover, collect, and sell extraordinary NFTs</h1>
                    <p>Explore on the world's best &amp; largest NFT marketplace</p>
                    <div class="button-group">
                      <a class="btn btn-bordered-white" href="/login">
                        <i class="icon-rocket mr-2"></i>Login </a>
                      <a class="btn btn-bordered-white" href="/register">
                        <i class="icon-note mr-2"></i>Sign Up </a>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-12">
                    <div class="intro mb-4">
                      <div class="intro-content">
                        <span>NFT</span>
                        <h3 class="mt-3 mb-0">What is an NFT?</h3>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row items">
                  <div class="col-12 item">
                    <div class="single-work">
                      <p>A non-fungible token (pronounced NFT) is a special type of cryptographic token that represents something unique. Non-fungible tokens are therefore not identically exchangeable.</p>
                      <h4>Alienfinity Collection</h4>
                      <p>Alienfinity are a collection of 3333 unique pieces minted on Ethereum Blockchain. The Alienfinity are your personal companion and will become your metaverse character, so be sure to get an Alien that you feel represents you. The rare (quirky) ones are created by our team of artists and Infinity partners across several hundred traits.</p>
                      <p>Alienfinity is always expanding and as our brand grows, Alien holders will have special access to the latest products, merchandise, events and Starking of up to 300% per year.</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="intro mb-4">
                      <div class="intro-content">
                        <span>Company</span>
                        <h3 class="mt-3 mb-0">About us</h3>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="footer-items">
                        ...
                        <div class="social-icons d-flex">
                          ...
                          <a class="google-plus" href="#">
                            ...
                            <!-- <i class="fab fa-google-plus-g"></i> Font Awesome fontawesome.com -->
                            <svg class="svg-inline--fa fa-google-plus-g fa-w-20" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google-plus-g" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
                              <path fill="currentColor" d="M386.061 228.496c1.834 9.692 3.143 19.384 3.143 31.956C389.204 370.205 315.599 448 204.8 448c-106.084 0-192-85.915-192-192s85.916-192 192-192c51.864 0 95.083 18.859 128.611 50.292l-52.126 50.03c-14.145-13.621-39.028-29.599-76.485-29.599-65.484 0-118.92 54.221-118.92 121.277 0 67.056 53.436 121.277 118.92 121.277 75.961 0 104.513-54.745 108.965-82.773H204.8v-66.009h181.261zm185.406 6.437V179.2h-56.001v55.733h-55.733v56.001h55.733v55.733h56.001v-55.733H627.2v-56.001h-55.733z"></path>
                            </svg>
                            <!-- <i class="fab fa-google-plus-g"></i> Font Awesome fontawesome.com -->
                          ...
                          <a class="vine" href="#">
                            <svg class="svg-inline--fa fa-vine fa-w-12" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="vine" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                            ...
                            <!-- <i class="fab fa-vine"></i> Font Awesome fontawesome.com -->
                            <svg class="svg-inline--fa fa-vine fa-w-12" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="vine" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                              <path fill="currentColor" d="M384 254.7v52.1c-18.4 4.2-36.9 6.1-52.1 6.1-36.9 77.4-103 143.8-125.1 156.2-14 7.9-27.1 8.4-42.7-.8C137 452 34.2 367.7 0 102.7h74.5C93.2 261.8 139 343.4 189.3 404.5c27.9-27.9 54.8-65.1 75.6-106.9-49.8-25.3-80.1-80.9-80.1-145.6 0-65.6 37.7-115.1 102.2-115.1 114.9 0 106.2 127.9 81.6 181.5 0 0-46.4 9.2-63.5-20.5 3.4-11.3 8.2-30.8 8.2-48.5 0-31.3-11.3-46.6-28.4-46.6-18.2 0-30.8 17.1-30.8 50 .1 79.2 59.4 118.7 129.9 101.9z"></path>
                            </svg>
                            <!-- <i class="fab fa-vine"></i> Font Awesome fontawesome.com -->
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                        <div class="copyright-left">©2022 Alienfinity, All Rights Reserved.</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div id="search" class="modal fade p-0">
              <div class="modal-dialog dialog-animated">
                <div class="modal-content h-100">
                  <div class="modal-header" data-dismiss="modal">Search <svg class="svg-inline--fa fa-times-circle fa-w-16 icon-close" aria-hidden="true" focusable="false" data-prefix="far" data-icon="times-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
            ...
            <div id="menu" class="modal fade p-0">
              <div class="modal-dialog dialog-animated">
                <div class="modal-content h-100">
                  <div class="modal-header" data-dismiss="modal">Menu <svg class="svg-inline--fa fa-times-circle fa-w-16 icon-close" aria-hidden="true" focusable="false" data-prefix="far" data-icon="times-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                      <path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm101.8-262.2L295.6 256l62.2 62.2c4.7 4.7 4.7 12.3 0 17l-22.6 22.6c-4.7 4.7-12.3 4.7-17 0L256 295.6l-62.2 62.2c-4.7 4.7-12.3 4.7-17 0l-22.6-22.6c-4.7-4.7-4.7-12.3 0-17l62.2-62.2-62.2-62.2c-4.7-4.7-4.7-12.3 0-17l22.6-22.6c4.7-4.7 12.3-4.7 17 0l62.2 62.2 62.2-62.2c4.7-4.7 12.3-4.7 17 0l22.6 22.6c4.7 4.7 4.7 12.3 0 17z"></path>
                    </svg>
                    <!-- <i class="far fa-times-circle icon-close"></i> Font Awesome fontawesome.com -->
                  </div>
                    ...
                    <div class="row w-100">
                      <div class="items p-0 col-12 text-center">
                        <ul class="navbar-nav items mx-auto">
                          ...
                          <li class="nav-item dropdown">
                            <a class="nav-link" href="#">Explore <svg class="svg-inline--fa fa-angle-down fa-w-10 ml-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                            ...
                            <ul class="dropdown-menu">
                              <li class="nav-item">
                                <a href="/explore-1" class="nav-link">Explore Style 1</a>
                              </li>
                              <li class="nav-item">
                                <a href="/explore-2" class="nav-link">Explore Style 2</a>
                              </li>
                              <li class="nav-item">
                                <a href="/explore-3" class="nav-link">Explore Style 3</a>
                              </li>
                              <li class="nav-item">
                                <a href="/explore-4" class="nav-link">Explore Style 4</a>
                              </li>
                              <li class="nav-item">
                          ...
                          <li class="nav-item dropdown">
                            <a class="nav-link" href="#">Community <svg class="svg-inline--fa fa-angle-down fa-w-10 ml-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                                <path fill="currentColor" d="M143 352.3L7 216.3c-9.4-9.4-9.4-24.6 0-33.9l22.6-22.6c9.4-9.4 24.6-9.4 33.9 0l96.4 96.4 96.4-96.4c9.4-9.4 24.6-9.4 33.9 0l22.6 22.6c9.4 9.4 9.4 24.6 0 33.9l-136 136c-9.2 9.4-24.4 9.4-33.8 0z"></path>
                              </svg>
                              <!-- <i class="fas fa-angle-down ml-1"></i> Font Awesome fontawesome.com -->
                            </a>
                          ...
                          <li class="nav-item dropdown">
                            <a class="nav-link" href="#">Pages <svg class="svg-inline--fa fa-angle-down fa-w-10 ml-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg="">
                                <path fill="currentColor" d="M143 352.3L7 216.3c-9.4-9.4-9.4-24.6 0-33.9l22.6-22.6c9.4-9.4 24.6-9.4 33.9 0l96.4 96.4 96.4-96.4c9.4-9.4 24.6-9.4 33.9 0l22.6 22.6c9.4 9.4 9.4 24.6 0 33.9l-136 136c-9.2 9.4-24.4 9.4-33.8 0z"></path>
                              </svg>
                              <!-- <i class="fas fa-angle-down ml-1"></i> Font Awesome fontawesome.com -->
                            </a>
            ...
            <div id="scroll-to-top" class="scroll-to-top" style="display: none;">
              <a href="#header" class="smooth-anchor">
                <svg class="svg-inline--fa fa-arrow-up fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-up" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                  <path fill="currentColor" d="M34.9 289.5l-22.2-22.2c-9.4-9.4-9.4-24.6 0-33.9L207 39c9.4-9.4 24.6-9.4 33.9 0l194.3 194.3c9.4 9.4 9.4 24.6 0 33.9L413 289.4c-9.5 9.5-25 9.3-34.3-.4L264 168.6V456c0 13.3-10.7 24-24 24h-32c-13.3 0-24-10.7-24-24V168.6L69.2 289.1c-9.3 9.8-24.8 10-34.3.4z"></path>
                </svg>
                <!-- <i class="fas fa-arrow-up"></i> Font Awesome fontawesome.com -->
              </a>
            </div>
          </div>
        </div>
    ...
    <script>
      ! function(e) {
        ...
        var a = this.webpackJsonpnetstorm = this.webpackJsonpnetstorm || [],
          c = a.push.bind(a);
        a.push = t, a = a.slice();
    ...
    <script src="/static/js/2.27e1a73f.chunk.js"></script>
    <script src="/static/js/main.fd8cf001.chunk.js"></script>
  </body>
</html>